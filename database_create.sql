...
create table rooms (id bigint not null auto_increment, game_type integer, game_started bit, host_id bigint, zone_id bigint, zone_control_id bigint, primary key (id)) engine=InnoDB
