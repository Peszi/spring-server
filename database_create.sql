...
create table teams (id integer not null, room_id bigint not null, alias varchar(32), primary key (id, room_id)) engine=InnoDB
create table users (id bigint not null auto_increment, active bit not null, deleted bit not null, email varchar(255), name varchar(255), password varchar(255), token varchar(255), team_id integer, room_id bigint, primary key (id)) engine=InnoDB
...
alter table users add constraint FKnwd83l2hdnbx3sjg6ytdnl2f9 foreign key (team_id, room_id) references teams (id, room_id)
